...
export default function AgriculturePage() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      description: "Gestion de la production rizicole. Bac+3 minimum en agronomie. Expérience 5 ans minimum.",
    },
    {
      id: 105,
    ...
    },
    {
      ...
      description: "Préparation des sols et travaux agricoles. Permis tracteur exigé. Mission de 2 mois renouvelable.",
    },
    {
      id: 107,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold mb-2">Secteur : Agriculture</h1>
          <p className="text-gray-600">
            Découvrez toutes les opportunités dans l'agriculture, l'élevage et l'agroalimentaire
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <Input placeholder="Rechercher un emploi dans l'agriculture..." />
            </div>
