...
export default function ProfesseurPage() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      description: "Enseignement de la programmation et des bases de données. Expérience professionnelle requise.",
    },
    {
      id: 405,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold mb-2">Emplois : Professeur</h1>
          <p className="text-gray-600">
            Trouvez des opportunités dans l'enseignement, le soutien scolaire et la formation
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <Input placeholder="Rechercher un emploi d'enseignant..." />
            </div>
